...
def run_training_pipeline():
    ...
    print("✅ Model metadata profiles saved locally.")
    ...
    with open("rf_dishonor_model.onnx", "wb") as f:
        f.write(onnx_model.SerializeToString())
    print("🚀 ONNX serialization complete! Model saved to 'rf_dishonor_model.onnx'.")
